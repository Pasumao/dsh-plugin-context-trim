...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '.dshtrim-btnPrimary{appearance:none;cursor:pointer;border-radius:999px;border:1px solid transparent;background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary-inverted);font-size:12px;line-height:18px;padding:5px 14px;font-family:inherit}',
      '.dshtrim-btnPrimary:hover:not(:disabled){filter:brightness(1.08)}',
      '.dshtrim-btnPrimary:disabled{cursor:default;opacity:.55}',
